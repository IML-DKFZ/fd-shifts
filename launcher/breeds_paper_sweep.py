        ...
        if 1 == 1:
            ...
            if train_mode == "test":
                ...
                if mode == "devries":
                    ...
                    command_line_args += "trainer.optimizer.weight_decay={} ".format(
                        0.0001
                    )
                ...
                command_line_args += "trainer.batch_size={} ".format(
                    128
                )  # 128 takes around 16 gb
                command_line_args += "model.network.imagenet_weights_path={} ".format(
                    "$EXPERIMENT_ROOT_DIR/pretrained_weights/resnet50-19c8e357.pth"
                )
                ...
                command_line_args += '+eval.query_studies.in_class_study="{}" '.format(
                    ["breeds_ood_test"]
                )
