...
@pytest.mark.parametrize(
    ...
    [
        ...
        # "medshifts/ms_xray_chestallnih14/confidnet_bbdensenet121_run1",
        # "medshifts/ms_xray_chestallnih14/deepgamblers_bbdensenet121_run1",
        # "medshifts/ms_xray_chestallnih14/devries_bbdensenet121_run1",
    ],
)
def test_medshifts_experiment_configs(exp_name) -> None:
    ...
    reference_config["trainer"]["optimizer"][
        "_target_"
    ] = f"torch.optim.{optim_name.lower()}.{optim_name}"
